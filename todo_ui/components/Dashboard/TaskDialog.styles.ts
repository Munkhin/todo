export const taskDialogStyles = {
  ...
  // Elevate panel above overlay, scale to 90% height
  panel: "relative z-50 w-full max-w-md h-[90svh] flex flex-col rounded-lg border bg-white shadow-xl",
  header: "flex-shrink-0 border-b p-[clamp(0.75rem,2vh,1rem)] text-lg font-semibold",
  body: "flex-1 p-[clamp(0.75rem,2vh,1rem)] space-y-3 overflow-auto",
  ...
  footer: "flex-shrink-0 flex justify-end gap-2 border-t p-[clamp(0.75rem,2vh,1rem)]",
